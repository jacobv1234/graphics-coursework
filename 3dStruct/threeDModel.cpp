 ...
 *	Scope	: Public
 *
 *	Purpose	: Return true if the provided point is in this octree
 *
 *	Returns	: bool
 */
bool CThreeDModel::OctreeCollision(float x, float y, float z)
{
	if (m_pobOctree != nullptr)
	{
		return m_pobOctree->OctreeCollision(x,y,z);
	}
}
